...
if __name__ == '__main__':
    ...
    for num_SRs in num_SRs_list:
        for num_UEs, num_APs in all_scenarios:
            data_file_name = f'Data/17Mar/{num_APs}AP_{num_UEs}UE_{num_SRs}SR.pkl'
            print(f"Running all_bench for {num_APs} APs, {num_UEs} UEs, and {num_SRs} SRs...")
            # Call function
            generate_all_data(num_samples, num_APs, num_UEs, num_SRs, gamma_thr, nu, power_receiver, p_dl, data_file_name)
